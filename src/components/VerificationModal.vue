<template>
  <Teleport to="body">
    <Transition name="modal">
      <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50" @click.self="close">
        <div class="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 sm:p-8">
          <div class="text-center mb-6">
            <div class="mx-auto w-16 h-16 bg-verde-sidebar bg-opacity-10 rounded-full flex items-center justify-center mb-4">
              <svg class="w-8 h-8 text-verde-sidebar" fill="none" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
            <h2 class="text-2xl font-bold text-gray-900 mb-2">Verificar Email</h2>
            <p class="text-gray-600">
              Ingresá el código de verificación que enviamos a <br />
          ...
          <div class="space-y-3">
            ...
            >
              <span v-if="!resendDisabled">Reenviar código</span>
...
const resendCode = () => {
  ...
  error.value = '';
  success.value = 'Código reenviado! Revisá tu email.';
  emit('resend');
